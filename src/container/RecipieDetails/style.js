...
const styles = StyleSheet.create({
  ...
  myfavccs: {paddingVertical: 10, marginTop: 0},
  ...
  myfavlistcontainerchildColumn: {
    alignItems: 'center',
    justifyContent: 'center',
  },
  image: {height: 74, width: 120, resizeMode: 'cover', borderRadius: 15},
  imageDrop: {height: 120, width: 140, resizeMode: 'cover', borderRadius: 15},
  imagea: {height: 70, width: 85, resizeMode: 'cover', borderRadius: 10},
  ml_0: {
    marginLeft: 0,
  ...
  smallbucket: {height: 12, width: 12, resizeMode: 'contain'},
  mealimg: {
    height: 140,
    width: 90,
    borderRadius: 10,
