...
const styles = StyleSheet.create({
  ...
  hearts: {height: 30, width: 30, resizeMode: 'contain', marginRight: 10},
  headingtextBlack: {
  ...
  ml_15: {marginLeft: 15, fontFamily: 'Poppins-Regular', color: colors.black},
  ml_1: {marginLeft: 15, fontFamily: 'Poppins-SemiBold', color: colors.black},
  ml_s: {
    marginLeft: 7,
  ...
  favmealsC: {
    ...
    // alignItems: 'center',
    // justifyContent: 'center',
    width: Utility.getInstance().widthToDp(63),
    borderRadius: 5,
    //padding: 5,
  },
  melaname: {
  ...
  mealinnerc: {
    ...
    width: Utility.getInstance().DW() / 2.8,
    //flex: 1,
    // height: 50,
    // flex: 1,
  },
