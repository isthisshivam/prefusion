...
const styles = StyleSheet.create({
  ...
  smallbucket: {height: 18, width: 18, resizeMode: 'contain'},
  heart: {height: 25, width: 25, resizeMode: 'contain', borderRadius: 10},
  userlogoSizeBig: {
    height: 45,
    width: 75,
    resizeMode: 'contain',
  ...
  progressbar: {alignItems: 'center', margin: 0},
  ...
  favmealsC_foods: {
    ...
    margin: 10,
    height: 175,
    width: Utility.getInstance().widthToDp(85),
    borderRadius: 5,
    padding: 5,
  },
