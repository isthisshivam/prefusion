...
const styles = StyleSheet.create({
  ...
  codeimage: {height: 24, width: 24, resizeMode: 'contain'},
  donec: {height: 30, paddingHorizontal: 30},
  mt_minus_20: {marginTop: -20},
  lbs: {
    marginTop: -32,
    fontSize: 10,
    alignSelf: 'center',
  ...
  smallbucket: {height: 16, width: 16, resizeMode: 'contain'},
  heart: {height: 20, width: 20, resizeMode: 'contain'},
  hearts: {height: 30, width: 30, resizeMode: 'contain', marginRight: 5},
  userlogoSizeBig: {
    height: 45,
    width: 75,
    resizeMode: 'contain',
  ...
  progressbar: {alignItems: 'center', margin: 1},
  ...
  favmealsC: {
    ...
    padding: 5,
    borderWidth: 1,
    borderColor: colorCodes.secondary,
  },
  favmealsCC: {
    margin: 10,
    height: 175,
  ...
  dropdown4DropdownStyle: {backgroundColor: '#EFEFEF', borderRadius: 2},
  ...
  mealinnerc: {
    ...
    paddingHorizontal: 5,
    flex: 1,
    width: Utility.getInstance().DW() / 2.3,
  },
  mealitemcopyMeal: {
    // flex: 1,
    alignItems: 'center',
    //width: '100%',
    width: Utility.getInstance().DW() / 1.4,
    borderRadius: 5,
    paddingHorizontal: 3,
    marginTop: 10,
  },
  mealitemc: {
    ...
    alignItems: 'center',
    //width: '100%',
    width: Utility.getInstance().DW() - 30,
    borderRadius: 5,
    paddingHorizontal: 5,
    marginTop: 10,
    shadowColor: '#000',
  ...
  minusimage: {height: 20, width: 20, resizeMode: 'contain'},
  submitdealview: {alignItems: 'center', height: 100},
